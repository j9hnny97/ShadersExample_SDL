...
void VulkanEngine::init_pipelines()
{
	...
	if (!load_shader_module(makePath("vulkan/colored_triangle.frag.spv").c_str(), &triangleFragShader))
	{
	...
	if (!load_shader_module(makePath("vulkan/colored_triangle.vert.spv").c_str(), &triangleVertexShader))
	{
	...
	if (!load_shader_module(makePath("vulkan/triangle.frag.spv").c_str(), &redTriangleFragShader))
	{
		std::cout << "Error when building the triangle fragment shader module" << std::endl;
	}
	else {
	...
	if (!load_shader_module(makePath("vulkan/triangle.vert.spv").c_str(), &redTriangleVertShader))
	{
		std::cout << "Error when building the triangle vertex shader module" << std::endl;
	}
	else {
